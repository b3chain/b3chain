...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "b3rt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6yyujvt")
        ...
        assert_equal(address4, "b3rt1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62ms4ayffc")
        ...
        assert_equal(address_fail, "b3rt1ql7zg7ukh3dwr25ex2zn9jse926f27xy23qauqc")
