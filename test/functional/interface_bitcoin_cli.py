...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"b3chain-cli -h\" for help or \"b3chain-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `b3chain-cli getblockchaininfo`")
        ...
        # Prevent b3chain-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and b3chain-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and b3chain-cli getwalletinfo return expected wallet info")
            ...
            # Test b3chain-cli -generate with -rpcwallet in multiwallet mode.
