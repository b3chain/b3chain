...
with the b3chaind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a b3chaind.  `P2PInterface`
...
Test objects for interacting with a b3chaind node over the p2p interface.
