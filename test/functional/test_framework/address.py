...
ADDRESS_BCRT1_UNSPENDABLE = 'b3rt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqw543yf'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(b3rt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqw543yf)#up65me3z'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'b3rt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqsaupw7'
...
def create_deterministic_address_bcrt1_p2tr_op_true(explicit_internal_key=None):
    ...
    if explicit_internal_key is None:
        assert_equal(address, 'b3rt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqsejuelh')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("b3" if main else "b3rt", version, program)
