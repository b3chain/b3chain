...
This audit has been renamed to `audit-b3pow-isolation.py`. The audit
ID `H-1` is unchanged so doc/SECURITY-AUDIT.md cross-references still
resolve.
...
NEW_SCRIPT = HERE / "audit-b3pow-isolation.py"

print(
    "[DEPRECATED] audit-pow-isolation.py has been renamed to "
    "audit-b3pow-isolation.py (B3PoW-Scratch v1.1).  Forwarding...",
    file=sys.stderr,
)
