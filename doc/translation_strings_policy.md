...
This document provides guidelines for internationalization of the B3Chain Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to B3Chain network</source>
        <translation>
            <numerusform>%n active connection to B3Chain network</numerusform>
            <numerusform>%n active connections to B3Chain network</numerusform>
        </translation>
    </message>
