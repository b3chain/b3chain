...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *b3chain-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *b3chain-qt* and *b3chain-gui* executables. |
| *libbitcoin_ipc*         | IPC functionality used by *b3chain-node* and *b3chain-gui* executables to communicate when [`-DENABLE_IPC=ON`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *b3chaind* and *b3chain-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *b3chaind* and *b3chain-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *b3chain-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *b3chaind* and *b3chain-qt* executables. |
...
b3chain-cli[b3chain-cli]-->libbitcoin_cli;

b3chaind[b3chaind]-->libbitcoin_node;
b3chaind[b3chaind]-->libbitcoin_wallet;

b3chain-qt[b3chain-qt]-->libbitcoin_node;
b3chain-qt[b3chain-qt]-->libbitcoinqt;
b3chain-qt[b3chain-qt]-->libbitcoin_wallet;

b3chain-wallet[b3chain-wallet]-->libbitcoin_wallet;
b3chain-wallet[b3chain-wallet]-->libbitcoin_wallet_tool;
...
class b3chain-qt,b3chaind,b3chain-cli,b3chain-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different B3Chain Core applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
