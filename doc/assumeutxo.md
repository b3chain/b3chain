...
Assumeutxo is a feature that allows fast bootstrapping of a validating b3chaind
instance.
...
```
$ b3chain-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ b3chain-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
