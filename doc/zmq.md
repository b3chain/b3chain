...
The B3Chain Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in B3Chain Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ b3chaind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/b3chaind.tx.raw \
...
From the perspective of b3chaind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into b3chaind directly. Furthermore, no information is
...
using. B3chaind appends an up-counting sequence number to each
