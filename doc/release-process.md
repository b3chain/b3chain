...
* Update b3chain.conf and commit changes if they exist, see [gen-b3chain-conf.sh](/contrib/devtools/README.md#gen-b3chain-confsh).
...
* Update the following variables in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `m_assumeutxo_data` array should be appended to with the values returned by calling `b3chain-cli -rpcclienttimeout=0 -named dumptxoutset utxo.dat rollback=<height or hash>`
