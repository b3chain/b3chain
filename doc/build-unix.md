UNIX BUILD NOTES
====================
Some notes on how to build B3Chain Core in Unix.
...
memory available when compiling B3Chain Core. On systems with less, gcc can be
...
To build B3Chain Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, B3Chain Core can
