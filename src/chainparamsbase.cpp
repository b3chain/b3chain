...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 8534);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 18534);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 48534);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 38534);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 18545);
    }
    assert(false);
}
