...
{
    switch (unit) {
    case Unit::BTC: return QString("B3C");
    case Unit::mBTC: return QString("Milli-B3C (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-B3C (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
